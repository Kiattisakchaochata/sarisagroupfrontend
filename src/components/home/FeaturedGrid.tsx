...
export default function FeaturedGrid({
  ...
  return (
    <section>
      ...
      <div className="relative">
        ...
        <div
          ref={trackRef}
          className="flex overflow-x-auto snap-x snap-mandatory scroll-smooth px-1 -mx-1 [scrollbar-width:none]"
          style={{ gap: `${gapPx}px` }}
        >
          {rows.map((it) => (
  <Link
  ...
  >
    ...
    <div className="relative">
      ...
      {typeof it.avg_rating === 'number' && it.avg_rating > 0 && (
        <div className="absolute top-2 right-2 bg-black/70 text-white text-xs px-2 py-1 rounded-full flex items-center gap-1 pointer-events-none">
          {/* ดาวแบบ svg เพื่อไม่ต้องติดตั้งไลบรารีเพิ่ม */}
    ...
    {/* Caption: รองรับ 2 บรรทัด + ลดกรอบขาวให้พอดี */}
